...
//        init();
    ...
    private void init() {
        ...
        paint.setColor(Color.parseColor("#f39e0a"));

        paint1 = new Paint(Paint.ANTI_ALIAS_FLAG);
        paint1.setColor(Color.parseColor("#f3770a"));

        paint2 = new Paint(Paint.ANTI_ALIAS_FLAG);
        paint2.setColor(Color.parseColor("#f3500a"));

        paint3 = new Paint(Paint.ANTI_ALIAS_FLAG);
        paint3.setColor(Color.parseColor("#f3290a"));

        paint4 = new Paint(Paint.ANTI_ALIAS_FLAG);
        paint4.setColor(Color.parseColor("#f30a12"));
...
//    }
    ...
    private class DecelerateAccelerateInterpolator implements TimeInterpolator, Interpolator {
